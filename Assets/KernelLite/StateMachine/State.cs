...
namespace Kernel.StateMachine
{
	...
	/// </summary>
	public interface IAbstractState : IDisposable
	{
		IConcreteStateDeclaration Declaration { get; set; }

		/// <summary>
		/// Parent state, or null if this is the root level state.
		/// </summary>
		IAbstractState Parent { get; set; }

		/// <summary>
		/// Root state.
		/// </summary>
		IAbstractState Root { get; set; }
		...
		/// <summary>
		/// Update this state and its children.
		/// </summary>
		void Update();
	...
	/// </summary>
	public abstract class AbstractState : IAbstractState
	{
		/// <summary>
		...
		public IConcreteStateDeclaration Declaration { get; set; }

		/// <summary>
		/// Parent state, or null if this is the root level state.
		/// </summary>
		public IAbstractState Parent { get; set; }

		/// <summary>
		/// Root state.
		/// </summary>
		public IAbstractState Root { get; set; }

		/// <summary>
		/// Stack of active child states.
		/// </summary>
		private readonly Stack<IAbstractState> activeChildren = new Stack<IAbstractState>();

		/// <summary>
		/// Dictionary of all children (active and inactive), and their names.
		/// </summary>
		private readonly IDictionary<string, IAbstractState> children = new Dictionary<string, IAbstractState>();
		...
		/// <summary>
		/// Update this state and its children with.
		/// </summary>
		public void Update()
		{
		...
		/// </summary>
		public void AddChild(IAbstractState newState, string stateName)
		{
			try
			{
		...
		/// </summary>
		public void AddChild(IAbstractState newState)
		{
		...
		/// <summary>
		/// Action which passes the current state object.
		/// </summary>
		public void SetUpdateAction(Action onUpdate)
		{
	...
	/// </summary>
	public class AbstractRootState : AbstractState
	{
	}
}
